...
"""
================================================================================
:mod:`config_cli` -- PROZA program CLI configuration
================================================================================

.. module:: config_cli
   :synopsis: PROZA program CLI configuration
...
class _XPPCLI(CLI):
    ...
    def configure(self, console, settings):
        section = settings.add_section('proza')
        ...
        # jar
        question = 'Path to pymontecarlo-dtsa2-proza.jar'
