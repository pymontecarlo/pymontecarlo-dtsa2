...
"""
================================================================================
:mod:`config_gui` -- PROZA program GUI configuration
================================================================================

.. module:: config_gui
   :synopsis: PROZA program GUI configuration
...
from pymontecarlo.program.proza.config import program
...
class _PROZAGUI(GUI):
    ...
    def create_configure_panel(self, parent=None):
        ...
        """
        return _PROZAConfigurePanelWidget(program, parent)
